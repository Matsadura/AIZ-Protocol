...
int main()
{
    ...
    expect_router_result(main_site, "/indexed_dir/html/normaldir/../normaldir/../../../",
                         RouterResult(400, RouterResource::get_default_page(main_site, 400), RouterResult::FILE_PATH));
    ...
    expect_router_result(main_site, "/noindex/",
                         RouterResult(403, RouterResource::get_default_page(main_site, 403), RouterResult::FILE_PATH));
    ...
    expect_router_result(main_site, "/does-not-exist.txt",
                         RouterResult(404, RouterResource::get_default_page(main_site, 404), RouterResult::FILE_PATH));
